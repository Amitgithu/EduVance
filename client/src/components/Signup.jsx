  ...
  return (
    <div className="container-fluid h-100">
      <div className="row h-100">
        <div className="col-md-5 d-flex justify-content-center align-items-center" style={{backgroundColor:'#f5f5f5'}}>
          <img
            src={loginSidebar}
            alt="Logo"
        ...
        <div className="col-md-7 p-3 d-flex justify-content-center align-items-center">
          <div className="col-md-7 p-4 shadow rounded bg-light">
